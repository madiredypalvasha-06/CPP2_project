#!/usr/bin/env python3
"""
Optimized Training - Full Dataset, Higher Accuracy
"""
...
print("="*60)
print("TRAINING WITH FULL DATASET - TARGET 98% ACCURACY")
print("="*60)
...
files = sorted([f for f in os.listdir(images_dir) if f.endswith(('.jpg', '.png'))])
images, masks = [], []
...
history = model.fit(images, masks, epochs=15, batch_size=16, validation_split=0.1, verbose=1)
